...
public class CriaOrdemService {
	...
	public CriaOrdemService(Validator pValidator, LogisticaRepository pLogisticaRepository) {
		this.validator = pValidator;
		this.logisticaRepository = pLogisticaRepository;
	}

	public OrdemServicoVO processar(OrdemServicoVO ordemServicoVO) {
		Set<ConstraintViolation<OrdemServicoVO>> validateMessages = this.validator.validate(ordemServicoVO);
