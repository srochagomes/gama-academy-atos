...
public class NotaFiscalDevolucaoFactoryTest {
	...
	public void test_quandoCriarEntityPeloVO_sohTransformaparaEntity() {
		...
		notaFiscal.setIdNotaFiscalVenda(33l);
		...
		NotaFiscalDevolucaoEntity entityCriada = 
				new NotaFiscalDevolucaoFactory(notaFiscal).toEntity();
		...
		assertNotNull(entityCriada.getIdNotaFiscalVenda());
		assertEquals(notaFiscal.getIdNotaFiscalVenda(),entityCriada.getIdNotaFiscalVenda());
		...
		NotaFiscalVO voCriado = 
				new NotaFiscalDevolucaoFactory(entityCriada).toVO();
		...
		assertNotNull(voCriado.getIdNotaFiscalVenda());
		assertEquals(notaFiscal.getIdNotaFiscalVenda(),voCriado.getIdNotaFiscalVenda());
